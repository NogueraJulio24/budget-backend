...
class CreditCardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create credit_card" do
    assert_difference('CreditCard.count') do
      post credit_cards_url, params: { credit_card: { close_day: @credit_card.close_day, limit: @credit_card.limit, name: @credit_card.name, pay_day: @credit_card.pay_day } }
    end
  ...
  test "should update credit_card" do
    patch credit_card_url(@credit_card), params: { credit_card: { close_day: @credit_card.close_day, limit: @credit_card.limit, name: @credit_card.name, pay_day: @credit_card.pay_day } }
